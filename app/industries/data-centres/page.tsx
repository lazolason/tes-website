      ...
      <section className="border-b bg-blue-50">
        <div className="mx-auto max-w-6xl px-4 py-14 lg:py-20">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            <FadeIn delay={100}>
              <div className="rounded-lg bg-white border border-blue-100 p-5">
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 lg:py-20">
          <div className="flex flex-col gap-4 rounded-lg border bg-gray-50 p-6 shadow-sm md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-2 text-xs">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-md bg-blue-700 px-5 py-2.5 font-semibold text-white shadow-sm hover:bg-blue-800"
              >
                Contact Us
              </Link>
              <Link
                href="/knowledge-hub"
                className="inline-flex items-center justify-center font-semibold text-blue-700 hover:text-blue-900"
              >

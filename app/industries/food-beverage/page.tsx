...
import FoodBeverageSchematic from "../../../components/schematics/FoodBeverageSchematic";
  ...
  return (
    <main id="main-content" className="min-h-screen bg-white">
      ...
      <IndustryCTA
        ...
        description="Let's discuss how TES can reduce energy costs and downtime."
      />
    </main>
  );
}

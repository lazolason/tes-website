      ...
      <section className="border-b bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 py-16 lg:py-24">
          <div className="text-center mb-8">
            ...
            <p className="mt-5 max-w-3xl mx-auto text-base leading-relaxed text-gray-600">
          ...
          <div className="mt-10 relative h-96 md:h-[32rem] lg:h-[40rem]">
            <Image
              src="/mexel-solution-infographic.png"
              alt="Mexel432 solution: Biofilm problem, molecular film mechanism, 40% performance improvement at Kriel"
              fill
      ...
      <section className="border-b">
        <div className="mx-auto max-w-6xl px-4 py-14 lg:py-20">
          ...
          <div className="mt-6 grid gap-8 md:grid-cols-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-900">Key characteristics</h3>
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 lg:py-20">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg border bg-white p-5 shadow-sm">
              <h3 className="text-sm font-semibold text-gray-900">Improved Heat Transfer</h3>
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 lg:py-20">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="rounded-lg border bg-gray-50 p-6">
              <h3 className="text-sm font-semibold text-gray-900">Kriel Power Station (South Africa)</h3>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">
                Mexel®432 application at Kriel showed <span className="font-semibold text-gray-900">40% performance improvement</span> on Unit 6, with significant temperature rise improvement demonstrated over a 90-day trial period.
              </p>
            ...
            <div className="rounded-lg border bg-gray-50 p-6">
              <h3 className="text-sm font-semibold text-gray-900">International References</h3>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">

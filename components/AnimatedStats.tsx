      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            {/* Image brief: /public/images/home-outcomes-cooling-water.webp — Cooling water in motion near condenser outflow, high shutter detail, industrial realism. */}
            <Image
              src="/images/home-outcomes-cooling-water.webp"

            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10 w-full">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm px-3 py-1 mb-8 animate-fade-in" style={{animationDelay:'0ms'}}>
                        ...
                        <div className="flex flex-wrap gap-4 mb-12 animate-fade-in" style={{animationDelay:'300ms'}}>
                            ...
                            <a
                                ...
                                className={cn(buttonVariants({ variant: "outline", size: "lg" }), "border-emerald-400 text-emerald-300 hover:bg-emerald-400/10")}
                        ...
                        <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-10 animate-fade-in" style={{animationDelay:'400ms'}}>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-lg bg-white/10 border border-white/20 flex items-center justify-center text-emerald-400 flex-shrink-0">
                    ...
                    <div className="relative mt-16 lg:mt-0 lg:col-span-6 xl:col-span-6 lg:flex lg:items-center">
                        <div className="relative w-full rounded-2xl border border-white/10 bg-slate-900/60 p-8 backdrop-blur-2xl shadow-2xl shadow-black/40 animate-slide-in-right">

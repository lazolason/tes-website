...
export const INDUSTRIES_DATA: Industry[] = [
    {
        ...
        image: '/schematics/power-energy-v2.png?v=2',
        icon: NavIcons.Power,
    ...
    },
    {
        ...
        image: '/schematics/mining-v2.png?v=2',
    ...
    },
    {
        ...
        image: '/schematics/refinery-v2.png?v=2',
    ...
    },
    {
        ...
        image: '/schematics/food-beverage-v2.png?v=2',
        icon: NavIcons.Food,
    ...
    },
    {
        ...
        image: '/schematics/sugar-ethanol-v2.png?v=2',
    ...
    },
    {
        ...
        image: '/schematics/agriculture-v2.png?v=2',
        icon: NavIcons.Agriculture,
    ...
    },
    {
        ...
        image: '/schematics/ports-v2.png?v=2',
        icon: NavIcons.Ports,

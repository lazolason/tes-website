...
export const INDUSTRIES_DATA: Industry[] = [
    ...
    image: '/schematics/power-energy-v2.png?v=2',        icon: NavIcons.Power,
    ...
    image: '/schematics/sugar-ethanol-v2.png?v=2',        icon: NavIcons.Agriculture,
    ...
    image: '/schematics/agriculture-v2.png?v=2',        icon: NavIcons.Agriculture,
    ...
    image: '/schematics/data-centre-v2.png?v=2:', icon: NavIcons.DataCentres, benefits: ['Reduce energy costs', 'Reliability of uptime', 'Sustainable chemistry'],
    },
    {
        id: 'ports',
    ...
    image: '/schematics/ports-v2.png?v=2',        icon: NavIcons.Ports,
